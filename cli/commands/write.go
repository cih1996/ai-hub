...
Write a file to knowledge or memory store.

Content can be provided via:
  --content "text"     Inline content
  echo "text" | ai-hub write <filename> --scope knowledge   Pipe from stdin
...
Examples:
  ai-hub write "my-note.md" --scope knowledge --content "# My Note"
  echo "hello" | ai-hub write "note.md" --scope memory
  cat file.md | ai-hub write "doc.md" --scope knowledge --group "MyTeam"
`)
	}
